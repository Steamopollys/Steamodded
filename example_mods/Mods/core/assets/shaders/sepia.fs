...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
    ...
    if (sepia.g > 0.0 || sepia.g < 0.0) {
        sepiaVec.r = (tex.r * 0.393) + (tex.g * 0.769) + (tex.b * 0.189);
        sepiaVec.g = (tex.r * 0.349) + (tex.g * 0.686) + (tex.b * 0.168);
        sepiaVec.b = (tex.r * 0.272) + (tex.g * 0.534) + (tex.b * 0.131);
    }
