...
MODDED_VERSION = "1.0.0-ALPHA-0613a-STEAMODDED"
...
function SMODS.create_mod_badges(obj, badges)
	if not G.SETTINGS.no_mod_badges and not obj.no_mod_badges and obj and obj.mod and obj.mod.display_name then
        local mods = {}
